...
var Affix = {
  ...
  getState: function(scrollHeight, height, offsetTop, offsetBottom) {
    ...
    const colliderTop = initializing ? scrollTop : this.element.getBoundingClientRect().top + scrollTop;
...
NexT.utils.getAffixParam = function() {
  ...
  const footerOffset = document.querySelector('.footer').offsetHeight;
